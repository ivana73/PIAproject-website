...
@Component({
  selector: 'app-korisnik-posao-dodavanje',
  templateUrl: './korisnik-posao-dodavanje.component.html',
  styleUrls: ['./korisnik-posao-dodavanje.component.css']
})
export class KorisnikPosaoDodavanjeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.objectService.getObjects(this.korisnik.username).subscribe({
